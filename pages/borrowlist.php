...
<body>
    ...
    <div class="container">
        <div class="row justify-content-around">
            ...
            $books_data = mysqli_query($connect, "SELECT * FROM borrow WHERE user_email= '$_SESSION[uemail]'");
            // $id = $books_slice['id'];
            while ($books_slice = mysqli_fetch_array($books_data)) :
                ...
                <div class="card m-3" style="width: 18rem;">
                    <img style="height: 300px;" class="card-img-top" src="../admin/images/books/<?php echo $books_slice['bimg']; ?>" alt="Card image cap">
                    <div class="card-body">
                        <h6 class="card-title text-center">Book Name: <?php echo $books_slice['book_name']; ?></h6>
                        <p class="card-title text-center">Author Name: <?php echo $books_slice['book_author']; ?></p>
                    </div>
                </div>
