                ...
                <div class="table-responsive">
                    <table class="table table-striped table-sm">
                        ...
                        <tbody>
                            ...
                            $books_data = mysqli_query($connect, "SELECT * FROM borrow");
                            // $id = $books_slice['id'];
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $books_slice['user_name']; ?></td>
                                   
                                    <td><?php echo $books_slice['user_email']; ?></td>
                                    <td><?php echo $books_slice['book_name']; ?></td>
                                    <td><?php echo $books_slice['book_author']; ?></td>
                                    <td><?php echo $books_slice['pick_date']; ?></td>
                                  

                                    <td>

                                    <a class="btn btn-danger" href='../inc/returnbooks.php?id=<?php echo $books_slice['id']; ?>'>Delete</a>
